...
const ABOUT_TEXT =
  "Passionate software developer with hands-on experience in full-stack web development, modern JavaScript frameworks, responsive UI design, and database management. I build scalable applications with React, Next.js, Node.js, PostgreSQL, Supabase and TypeScript. Let's build something incredible together!";
