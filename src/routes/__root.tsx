...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Full stack developer crafting scalable web applications, ERP systems and AI-powered assistants." },
      { name: "author", content: "Jawad Syed" },
      { property: "og:title", content: "Jawad Syed — Full Stack Developer" },
      { property: "og:description", content: "Full stack developer crafting scalable web applications, ERP systems and AI-powered assistants." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:site", content: "@jawadsyed" },
    ],
    links: [
